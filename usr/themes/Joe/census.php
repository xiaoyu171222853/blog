...
<head>
    ...
    <script async src="https://busuanzi.ibruce.info/busuanzi/2.3/busuanzi.pure.mini.js"></script><!--不蒜子计数器-->
</head>
                    ...
                    <div class="joe_census__server">
                        <div class="joe_census__server-item">
                            <div class="title">
                                <spans>实时负载</spans>
                                <div class="count">
                                    <spans class="core">0 核</spans>
                                    <spans class="split">/</spans>
                                    <spans class="ram">0 MB</spans>
                                </div>
                            </div>
                            <div class="content">
                                <div id="work"></div>
                        ...
                        <div class="joe_census__server-item">
                            <div class="title">
                                ...
                                <div class="count">
                                    ...
                                    <spans class="split">/</spans>
                                    <spans class="down">总接收：0 B</spans>
                                </div>
                            </div>
                            <div class="content">
                                <div id="flow"></div>
